...
define('dummy/initializers/browser/leaflet-assets', ['exports', 'ember', 'ember-get-config'], function (exports, _ember, _emberGetConfig) {
...
if (!runningTests) {
  require("dummy/app")["default"].create({"name":"ember-leaflet-google-mutant-layer","version":"v0.0.10"});
}
